...
BEGIN
  ...
  joined AS (
    SELECT
      ...
      -- cliente presente e ativo/trial no snapshot mais recente: base oficial, ignora churn antigo
  ...
  ins AS (
    ...
    SELECT
      ...
      CASE
        ...
        WHEN j.email_norm IS NOT NULL AND j.status_assinatura IS NOT NULL
      ...
      -- data de cancelamento só quando o cliente NÃO está ativo/trial na base mais recente
